<template>
    <div class="toast toast-center toast-middle space-y-8">
        ...
        <button class="btn btn-lg" @click="earthquakeTestClick">Earthquake Test</button>
        <button class="btn btn-lg" @click="getLoginUserFCMTokenClick">getLoginUserFCMToken</button>
...
const getLoginUserFCMTokenClick = () => {
    ...
    getToken(messaging, { vapidKey: 'BFlg7MDQYzVF1lM8mwLi7amKHiAAxWCFbFx_D4SkGu1mUb0J3UsRWkAwKwWZurBLzC1Q6oN0g2cX8UkMxvYDuPQ' }).then((currentToken) => {
    if (currentToken) {
